...
describe('Create User',function(){
    ...
    it('should not create a user if the password length < 6',function(done){
        var user = new User({
    ...
    after(function(done){
        mongoose.connection.collections['collections'].drop(function(err){
            require('../../config/db').stop(done);
        });
    });
});